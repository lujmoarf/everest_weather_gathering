...
df2 = pd.DataFrame(columns=['timestamp', 'location', 'temperature', 'relative_humidity', 'WS_Max_h', 'wind_direction', 'pressure', 'wind_speed_sec', 'precipitation','WS_Average','SW_IN_AVG','SW_OUT_AVG','LW_IN_AVG','LW_OUT_AVG','SR50','WS_Max_2','Wind_Avg_2','Wind_Dir_2','T_109'])
